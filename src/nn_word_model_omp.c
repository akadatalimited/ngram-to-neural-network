...
#define MAX_TEXT_LEN (1024 * 1024 * 1024) // was 16 * 1024 * 1024 this allows 1gb input text.
                               ...
                               float *x)
{
    ...
    #pragma omp parallel for private(c, v) schedule(static)
