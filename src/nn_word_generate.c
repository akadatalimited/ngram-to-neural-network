...
#define MAX_VOCAB 8192 // started with 4096 and ran out of words
...
{
    fprintf(stderr,
            "usage: %s model.bin \"seed words\" output_len [mode] [seed]\n"
...
int main(int argc, char *argv[])
{
    ...
    if (argc == 6) {
        rand_seed = (unsigned int)strtoul(argv[5], NULL, 10);
    } else {
